...
public class Step2A extends AppCompatActivity {

    private final StringBuilder step2a = new StringBuilder();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_step2_a);
        ...
        try {
            ...
            output.setText(step2a);
        }

        //Link yes_button to Step3B Activity
        Button yes_button = findViewById(R.id.button1);
        yes_button.setOnClickListener(v -> {
            intent = new Intent(this, Step3B.class);
            startActivity(intent);
        });

        //Link no_button to Step2B Activity
        Button no_button = findViewById(R.id.button2);
        no_button.setOnClickListener(v -> {
            intent = new Intent(this, Step2B.class
            );
            startActivity(intent);
        });
